      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex flex-col lg:flex-row flex-grow w-full h-auto space-x-0 lg:space-x-4 space-y-4 lg:space-y-0">
            ...
            {/* Total Statistics */}
            <div className="flex flex-col rounded-md bg-richblack-800 p-6 lg:min-w-[250px] lg:w-1/4">
          ...
          <div className="rounded-md bg-richblack-800 p-6">
            ...
            <div className="my-4 flex flex-col lg:flex-row items-start space-y-4 lg:space-y-0 lg:space-x-6">
