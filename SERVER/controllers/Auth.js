...
exports.sendotp= async (req,res) => {
    try{
        ...
        // check if user already exist by finding user with inputted email
        ...
        //Entry of this otp is to be created in DB
...
exports.signup = async (req,res)=> {
    try{
        ...
        // validate data(If all Details are present or not)
        ...
        // User ki entry create in DB 
        // DB mai save krke hi object ID aegi
...
exports.login = async (req,res)=> {
    ...
    // Find user with inputted email
    const user = await User.findOne({email}).populate("additionalDetails");

    // If user not found with inputed email
    if(!user) {
        return res.status(401).json({
            success:false,
    ...
    // generate JWT, after password matching from DB
